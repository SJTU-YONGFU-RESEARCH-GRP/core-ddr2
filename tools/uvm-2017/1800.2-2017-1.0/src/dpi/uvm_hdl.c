...
// hdl vendor backends are defined for VCS, QUESTA, XCELIUM and VERILATOR
...
// Verilator backend: provide a minimal stub implementation that disables
// HDL backdoor access but allows the rest of UVM DPI to compile and run.
// See `uvm_hdl_verilator.c` for details.
